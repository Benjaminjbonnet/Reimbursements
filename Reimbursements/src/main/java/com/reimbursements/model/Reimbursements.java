...
public class Reimbursements {
  ...
  static StandardServiceRegistry registry;
	...
	public static Handler viewAll= ctx->{
		...
		CriteriaQuery<Reimbursements> alquery = ebuilder.createQuery(Reimbursements.class);
		Root<Reimbursements> root = alquery.from(Reimbursements.class);
		alquery.select(root);
		
	List<Reimbursements> allReimbursements = esession.createQuery(alquery).getResultList();
